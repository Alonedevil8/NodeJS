...
const emailRegistro = async (datos) => {
  ...
  await transport.sendMail({
    ...
    <html>
      <head>
        <title>Confirmación de Cuenta - BienesRaices.com</title>
      </head>
      <body>
        <h1>¡Hola ${nombre}!</h1>
        <p>¡Gracias por registrarte en BienesRaices.com!</p>
...
const emailOlvidePassword = async (datos) => {
  ...
  await transport.sendMail({
    from: "BienesRaices.com",
    to: email,
    subject: "Restablecer contraseña en BienesRaices.com",
    text: "Restablecer contraseña en BienesRaices.com",
    html: `
    <html>
      <head>
        <title>Restablecer Contraseña - BienesRaices.com</title>
      </head>
      <body>
        <h1>¡Hola ${nombre}!</h1>
        <p>Hemos recibido una solicitud para restablecer la contraseña de tu cuenta en BienesRaices.com.</p>
        ...
        <p>¡Gracias por usar BienesRaices.com!</p>
      </body>
    </html>
  `,
  });
