...
const Propiedad = db.define("propiedades", {
  ...
  // Número de habitaciones en la propiedad (entero).
  habitaciones: {
    type: DataTypes.INTEGER(), // Tipo de datos: Número entero.
    allowNull: false, // No se permite un valor nulo.
  },
  
  // Número de espacios de estacionamiento (entero).
  estacionamiento: {
    type: DataTypes.INTEGER(), // Tipo de datos: Número entero.
    allowNull: false, // No se permite un valor nulo.
  },
  
  // Número de baños (entero).
  wc: {
    type: DataTypes.INTEGER(), // Tipo de datos: Número entero.
    allowNull: false, // No se permite un valor nulo.
  },
  ...
  calle: {
    type: DataTypes.STRING(60), // Tipo de datos: Cadena de texto (máximo 60 caracteres).
    allowNull: false, // No se permite un valor nulo.
  },
